        ...
        <div className="container-custom relative z-10 text-center px-4">
           <div className="hero-main-title mb-8 md:mb-12">
             <div className="inline-block px-4 py-2 md:px-6 md:py-2 bg-[#ff4500]/20 border border-[#ff4500] rounded mb-4 md:mb-6">
               <span className="text-[#ff4500] font-bold text-xs md:text-sm uppercase tracking-wider">{heroData.badge}</span>
             </div>
         ...
         <div className="container-custom">
           <div className="text-center">
             <h2 className="text-5xl md:text-6xl font-heading font-black text-white mb-4">
               {whyChooseUsData.heading.split(' ').slice(0, 2).join(' ')} <span className="text-[#ff4500]">{whyChooseUsData.heading.split(' ').slice(2).join(' ')}</span>
             </h2>
           ...
           <div className="grid grid-cols-1 md:grid-cols-12 gap-6 max-w-6xl mx-auto">
             ...
             <div className="bento-card md:col-span-8 bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-10 transition-all">
               <div className="mb-6">
                 <div className="text-sm text-[#ff4500] font-bold uppercase mb-2">{whyChooseUsData.mainFeature.badge}</div>
               ...
               <div className="grid grid-cols-3 gap-4">
                 {whyChooseUsData.mainFeature.stats.map((stat, idx) => (
                   <div key={idx} className="text-center p-4 bg-black/60 border border-[#ff4500]/30">
             ...
             <div className="bento-card md:col-span-4 bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-8 transition-all">
               <div className="text-sm text-[#ff4500] font-bold uppercase mb-2">{whyChooseUsData.progressTracking.badge}</div>
             ...
             <div className="bento-card md:col-span-6 bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-8 transition-all">
               <div className="text-sm text-[#ff4500] font-bold uppercase mb-2">{whyChooseUsData.nutrition.badge}</div>
             ...
             <div className="bento-card md:col-span-3 bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-8 transition-all text-center flex flex-col justify-center">
               <div className="text-sm text-[#ff4500] font-bold uppercase mb-2">{whyChooseUsData.support.badge}</div>
             ...
             {/* Proven Results */}
             <div className="bento-card md:col-span-3 bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-8 transition-all text-center flex flex-col justify-center">
               <div className="text-sm text-[#ff4500] font-bold uppercase mb-2">{whyChooseUsData.methods.badge}</div>
               <h3 className="text-2xl font-heading font-black text-white mb-2">
       ...
       <section className="stack-section section-padding bg-[#0f0f0f] relative overflow-hidden">
         <div className="container-custom">
           <div className="text-center mb-16">
             <h2 className="text-5xl md:text-6xl font-heading font-black text-white mb-4">
               {programsData.heading.split(' ')[0]} <span className="text-[#ff4500]">{programsData.heading.split(' ')[1]}</span>
             </h2>
             <p className="text-xl text-gray-400 max-w-2xl mx-auto">
         ...
         <div className="container-custom">
           <div className="text-center mb-16 lg:mb-32">
             <h2 className="text-4xl md:text-6xl font-heading font-black text-white mb-4">
               {transformationShowcaseData.heading.split(' ')[0]} <span className="text-[#ff4500]">{transformationShowcaseData.heading.split(' ')[1]}</span>
             </h2>
             <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                 ...
                 <div className="absolute bottom-6 left-6 right-6">
                   ...
                   <div className="flex gap-3 text-sm font-bold">
                     {transformationShowcaseData.featured.results.map((result, idx) => (
                       <span key={idx} className="px-4 py-2 bg-[#ff4500] text-white">{result.text}</span>
                     ))}
                   </div>
                 </div>
               </div>
         ...
         <div className="container-custom px-4">
           <div className="text-center mb-8 md:mb-12">
             <h2 className="text-3xl md:text-5xl lg:text-6xl font-heading font-black text-white mb-3 md:mb-4">
               {clientReviewsData.heading.split(' ')[0]} <span className="text-[#ff4500]">{clientReviewsData.heading.split(' ')[1]}</span>
             </h2>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto">
             {clientReviewsData.reviews.map((testimonial, idx) => (
               <div key={idx} className="testimonial-slide will-change-transform bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-[#ff4500] p-4 md:p-6 transition-all">
                 <div className="flex gap-1 mb-3 md:mb-4">
                   {[...Array(testimonial.rating)].map((_, i) => (
                     <span key={i} className="text-lg md:text-xl text-[#ff4500]">★</span>
                   ))}
                 </div>
         ...
         <div className="container-custom relative z-10">
           <div className="max-w-4xl mx-auto text-center">
             <h2 className="text-5xl md:text-6xl font-heading font-black text-white mb-6">
               {finalCtaData.heading.line1}<br />{finalCtaData.heading.line2.split(' ')[0]} <span className="text-[#ff4500]">{finalCtaData.heading.line2.split(' ')[1]}</span>
             </h2>
