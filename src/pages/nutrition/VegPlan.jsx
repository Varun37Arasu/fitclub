    ...
    <div className="pt-20 bg-[#0f0f0f]">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pb-16">
        <div className="absolute inset-0">
          <div className="absolute top-20 right-10 w-[700px] h-[700px] bg-orange-500 opacity-20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 left-10 w-[600px] h-[600px] bg-amber-600 opacity-15 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1.5s'}}></div>
        </div>
