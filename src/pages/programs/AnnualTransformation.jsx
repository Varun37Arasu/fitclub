        ...
        <div className="container-custom relative z-10 px-4 flex-1 flex items-center justify-center">
          <div className="program-hero-title text-center max-w-full w-full">
            <div className="inline-flex flex-col sm:flex-row items-center gap-3 md:gap-4 px-4 py-2 md:px-8 md:py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 mb-6 md:mb-8 border-2 md:border-4 border-black animate-pulse">
              <span className="text-white font-heading font-black text-sm md:text-2xl tracking-wider break-words">{annualData.hero.badge}</span>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading font-black leading-[0.95] tracking-tighter mb-6 md:mb-8 break-words px-2 max-w-full">
              <span className="block text-white">{annualData.hero.title.split(' ')[0]}</span>
              <span className="block text-[#ff4500] neon-text">{annualData.hero.title.split(' ').slice(1).join(' ')}</span>
            </h1>
        ...
        <div className="container-custom px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-black text-white mb-4 md:mb-6 leading-tight break-words px-2">
              {annualData.cta.heading.split(' ').slice(0, 2).join(' ')} <span className="text-[#ff4500]">{annualData.cta.heading.split(' ').slice(2).join(' ')}</span>
            </h2>
