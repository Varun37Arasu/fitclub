          ...
          <div className="program-hero-title text-center max-w-full w-full">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 mb-6 md:mb-8">
              <div className="px-4 py-2 md:px-8 md:py-4 bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500 border-2 md:border-4 border-black">
                <span className="text-txt-primary font-heading font-black text-sm md:text-2xl tracking-wider break-words">{twelveWeekData.hero.badge}</span>
              </div>
            ...
            <h1 className="text-4xl md:text-6xl lg:text-8xl font-heading font-black leading-[0.95] tracking-tighter mb-6 md:mb-8 break-words px-2 max-w-full">
              <span className="block text-txt-primary">{twelveWeekData.hero.title.split(' ')[0]}</span>
              <span className="block text-primary neon-text">{twelveWeekData.hero.title.split(' ').slice(1).join(' ')}</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 md:gap-6 justify-center w-full sm:w-auto px-4">
              <Link to="/payment?plan=12-week" className="btn-primary text-sm md:text-lg lg:text-xl px-8 md:px-12 py-3 md:py-6 text-center w-full sm:w-auto">
        ...
        <div className="container-custom px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-heading font-black text-txt-primary mb-4 md:mb-6 leading-tight break-words px-2">
              {twelveWeekData.cta.heading.split(' ').slice(0, 2).join(' ')} <span className="text-primary">{twelveWeekData.cta.heading.split(' ').slice(2).join(' ')}</span>
            </h2>
