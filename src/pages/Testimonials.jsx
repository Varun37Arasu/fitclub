              ...
              <button
                ...
                className={`px-4 py-2 md:px-6 md:py-3 font-heading font-black uppercase text-xs md:text-sm transition-all ${
                  filter === tab.id
                    ...
                    : 'bg-black/40 text-gray-400 border-2 border-gray-700 hover:border-primary hover:text-white'
                }`}
              >
                {tab.label}
              </button>
        ...
        <div className="container-custom">
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
             {filteredTransformations.map((transformation, idx) => (
               <div
                 key={idx}
                 className="transformation-card relative group bg-black/40 backdrop-blur-sm border-2 border-gray-800 hover:border-primary p-4 transition-all"
               >
                 ...
                 <div className="grid grid-cols-2 gap-2 mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    <div className="bg-black/60 border border-primary/50 p-3 text-center">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {videoTestimonialsData.videos.map((video, idx) => (
              <div key={video.id} className="relative aspect-video bg-[#242424] border-4 border-gray-700 hover:border-primary transition-all group overflow-hidden">
                <img
                  src={video.thumbnail}
                  alt="Video thumbnail"
                  className="w-full h-full object-cover"
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {reviewsData.reviews.map((review, idx) => (
              <div key={idx} className="bg-[#1a1a1a] border-2 border-gray-700 hover:border-primary p-8 transition-all">
